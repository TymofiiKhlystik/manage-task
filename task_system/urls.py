...
urlpatterns = [
    ...
    path(
        "task_detail/<int:pk>/", TaskDetailView.as_view(), name="task-detail"
    ),
    path("task_create/create/", TaskCreateView.as_view(), name="task-create"),
    path(
        "task_update/<int:pk>/update/",
        TaskUpdateView.as_view(),
        name="task-update"
    ),
    path(
        "task_delete/<int:pk>/delete/",
    ...
    path(
        "teams/<int:pk>/delete/", TeamDeleteView.as_view(), name="team-delete"
    ),
    # ----WORKERS----
